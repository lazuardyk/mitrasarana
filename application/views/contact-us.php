...
<html>
    <head>
        ...
        <title>Mitrasarana - Contact Us</title>
    </head>
    ...
    <body>
        ...
        <div class="container mt-4 mb-4">
            <p class="font-roboto" style="font-size: 20px;">Contact Us</p>
            <hr>
            <div class="row">
                <div class="col-3">
                    <ul class="nav flex-column nav-pills">
                        <li class="nav-item">
                          <a class="nav-link active" href="#">Address and Contact</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col-9">
                    <p class="font-playfair" style="font-weight: bold; font-size: 25px;">Address and Contact</p>
                    <div class="font-roboto">
                        We welcome your feedback on what you find useful on the website and any helpful ideas you may have for improvements. Also, please contact us with any questions and/or to request assistance, consultations or services.
                        <div class="row">
                            <div class="col sm-6">
                                <br><br><b>HEAD OFFICE</b><br>
                                Perkantoran Kedoya Elok Plaza Blok DC 47,<br>
                                JL. Panjang<br>
                                Jakarta 11520, Indonesia<br>
                                Phone : (+62-21) 5806180<br>
                                Fax : (+62-21) 5809185<br>
                                E-mail : pt_msc@cbn.net.id<br>
                            </div>
                            <div class="col sm-6">
                                <br><br><b>WORK SHOP</b><br>
                                Prima Center 2 Blok D2<br>
                                JL. Pesing Poglar,<br>
                                Jakarta Barat, 11710<br>
                                Phone : (+62-21) 29030935<br>
                            </div>
                        </div>
        ...
        <footer style="position: fixed; bottom:0; left:0; right:0; background-color: rgb(71, 37, 194); color: white; padding-top: 10px; padding-bottom: 10px;" class="text-center font-roboto">
